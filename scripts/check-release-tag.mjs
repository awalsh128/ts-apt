...
if (!/^v\d+\.\d+\.\d+(-[0-9A-Za-z.-]+)?$/.test(tag)) {
  fail(`Release tag '${tag}' is invalid. Expected semantic version format like v1.2.3 or v1.2.3-rc.1`);
}
...
console.log(`Release preflight passed for tag ${tag} and package version ${packageJson.version}.`);
