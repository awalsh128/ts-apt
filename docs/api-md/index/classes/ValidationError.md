...
Defined in: [src/errors.ts:19](https://github.com/awalsh128/ts-apt/blob/dev/src/errors.ts#L19)
...
Defined in: [src/errors.ts:25](https://github.com/awalsh128/ts-apt/blob/dev/src/errors.ts#L25)
