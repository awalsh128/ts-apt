...
[ts-apt](../../README.md) / [index](../README.md) / TsAptError

# Class: TsAptError

Defined in: [src/errors.ts:4](https://github.com/awalsh128/ts-apt/blob/copilot/fix-failing-github-actions-job-again/src/errors.ts#L4)
...
Defined in: [src/errors.ts:10](https://github.com/awalsh128/ts-apt/blob/copilot/fix-failing-github-actions-job-again/src/errors.ts#L10)
