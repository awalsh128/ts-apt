...
Defined in: [src/errors.ts:4](https://github.com/awalsh128/ts-apt/blob/dev/src/errors.ts#L4)
...
Defined in: [src/errors.ts:10](https://github.com/awalsh128/ts-apt/blob/dev/src/errors.ts#L10)
