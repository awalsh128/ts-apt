...
Defined in: [src/errors.ts:34](https://github.com/awalsh128/ts-apt/blob/dev/src/errors.ts#L34)
...
Defined in: [src/errors.ts:40](https://github.com/awalsh128/ts-apt/blob/dev/src/errors.ts#L40)
